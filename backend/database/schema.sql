...
create table article (
  ...
  CONSTRAINT author_id_fk FOREIGN KEY (author_id) REFERENCES author(id) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT publisher_id_fk FOREIGN KEY (publisher_id) REFERENCES publisher(id) ON DELETE CASCADE ON UPDATE NO ACTION
);
